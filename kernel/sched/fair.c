...
void reweight_entity(struct cfs_rq *cfs_rq, struct sched_entity *se, unsigned long weight);
...
{
	/* For BORE: Update base slice based on current configuration */
	sysctl_sched_base_slice = nsecs_per_tick;
	normalized_sysctl_sched_base_slice = nsecs_per_tick;
}
#endif
